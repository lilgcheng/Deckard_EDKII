...
@rem For EmulatorPkg.
@REM set PLATFORM_PARAMETER=EmulatorPkg\EmulatorPkg.dsc
@REM set ARCHITECTURE_PARAMETER=X64
@REM set OTHER_PARAMETERS=-D ADD_SHELL_STRING

@REM For OVMF package. 
set PLATFORM_PARAMETER=OvmfPkg\OvmfPkgX64.dsc
set ARCHITECTURE_PARAMETER=X64
set OTHER_PARAMETERS=-D DEBUG_ON_SERIAL_PORT -D ADD_SHELL_STRING
set OVMF_FD_FILES=%BUILD_FOLDER%\Ovmf%ARCHITECTURE_PARAMETER%\%BUILD_MODE%_%TOOL_PARAMETER%\FV\OVMF.fd
